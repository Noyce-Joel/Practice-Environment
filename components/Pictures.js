    ...
    useFrame(() => {
      ...
      return <group ref={group}>
        <Image rotation={[0, 0.5 / 1.7 ,0]} position={[-2, 0, 0]} scale={[4, height, 1]} url="/4.jpg" />
          ...
          <Image position={[-1.4, -height, 3.5]} scale={[1, 3, 1]} url="/3.jpg" />
          <Image position={[-0.6, -7.5, 3]} scale={[1, 2, 1]} url="/2.jpg" />
          <Image position={[0.75, -height+0.5, 3.4]} scale={1} url="/5.jpg" />
          <Image position={[0, -height * 1.5, 2.5]} scale={[width, -height / 2, 1.5]} url="/bg2.jpg" />
